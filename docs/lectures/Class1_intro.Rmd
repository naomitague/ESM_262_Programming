...
computational thinking (and problem-solving in general)"...."Relying
...
* For assignments/practice
  - make the outline/basic idea yourself; but use AI-tools for syntax
  - AI-tools to explain codes (including class examples)
  - AI-tools to help interpret error messages
...
# Here's my example - note a) providing detailed comments b) how I use ChatGPT
```{r}
...
# since plant require sunlight, lets see how NPP varies with solar radiation (will focus on direct first) - when looking at relationships between variables, simply plotting as points with x-y type graphs is helpful (dependent variable on y-axis - here with think NPP is dependent on solar radiation)
