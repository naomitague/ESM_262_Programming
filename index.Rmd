...
- learn some coding/programming best practices (that will make your data science life easier - whatever you do!)
  - modularity
  - documentation
  - testing
- gain familiarity with a few concepts that are part (in some way) of most programming languages (functions, looping, data types)

- learn some new Rskills that are helpful for a wide variety of data science applications
- learn how to code with partners
