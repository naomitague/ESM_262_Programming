...
# Questions on Starting_functions.html?

* scoping 

Recall our function definition
...
What will height, result, Keff be after you run the following code?

Write what you think the answer is before we check

```{r, eval=FALSE}

height=10
power_gen_orig(height=12, flow=2)
Keff
height
result
...
In additon to *in-line* documents - at the top of the *.R file where you define
