...
plant_energy = data.frame(cbind(height=h, flow=f, v1=v1, v2=v2))
plant_energy

ggplot(plant_energy, aes(height, v1))+geom_line()+
  geom_line(aes(height, v2), col="blue")+labs(x="Water height (m)", y="Power Generated kW")
