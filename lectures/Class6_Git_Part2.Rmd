...
# What if I commited my changes to a file, can I get it back
  ...
  5.1 make a change and save
  5.2 commit the change
  5.3 go to 'history' in the 'git' window
    Notice that every commit has a unique "SHA"
  5.4 find the commit that you want to go back to
  5.5 check that its what you want by looking at the changes
  5.5 view the file
  5.6 view its history
